...
//        }
        ...
        if (NaConfig.INSTANCE.getShowRecentChatsInDrawer().Bool()) items.add(new Item(nkbtnRecentChats, LocaleController.getString(R.string.RecentChats), R.drawable.msg_recent));
